    ...
    <section id="heroSection" className="hero--section">
      <div className="hero--section--content--box">
        <div className="hero--section--content">
          <p className="section--title">Hey, I'm Dhanuka</p>
          ...
          <p className="hero--section-description">
            ...
            <br /> creating dynamic and responsive web applications.
          </p>
        </div>
        <a
              href={"https://www.linkedin.com/in/dhanuka-weshan-64755a306"}
              target="_blank"
      ...
      <div className="social--icon">
          <ul>
            ...
            <li>
            <a
              href="https://github.com/Dhanuka2002"
              className="navbar--content"
              target="_blank"
              rel="noreferrer"
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M12 .5C5.648.5.5 5.648.5 12c0 5.086 3.293 9.389 7.86 10.914.574.105.786-.249.786-.554 0-.274-.01-1-.016-1.962-3.197.694-3.873-1.542-3.873-1.542-.523-1.33-1.278-1.684-1.278-1.684-1.045-.714.08-.699.08-.699 1.156.082 1.765 1.187 1.765 1.187 1.027 1.76 2.695 1.252 3.35.957.105-.744.403-1.253.732-1.542-2.552-.29-5.237-1.276-5.237-5.675 0-1.254.45-2.28 1.187-3.083-.12-.29-.515-1.462.112-3.048 0 0 .966-.31 3.167 1.177A10.91 10.91 0 0112 6.066c.98.004 1.97.133 2.89.39 2.198-1.487 3.162-1.177 3.162-1.177.63 1.586.235 2.758.115 3.048.74.803 1.185 1.829 1.185 3.083 0 4.41-2.69 5.382-5.25 5.667.414.36.78 1.07.78 2.158 0 1.559-.015 2.818-.015 3.2 0 .308.207.664.792.552C20.214 21.385 23.5 17.082 23.5 12c0-6.352-5.148-11.5-11.5-11.5Z"
                  fill="black"
                />
              </svg>
            </a>
